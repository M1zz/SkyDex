...
/// colour", above 30 is plainly a different colour.
///
/// This file was deleted on 2026-08-11, when the board stopped comparing colours
/// and started filing by the clock instead. It is back because the board is a
/// set of colours again: a slot is filled when something in the collection lands
/// inside its circle, and "inside" has to be measured the way an eye measures it.
/// Plain Lab distance would do it wrong in exactly the wrong place — it
/// exaggerates differences between blues, and most of a sky is blue.
